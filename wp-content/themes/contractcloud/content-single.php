...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
  <div class="jumbotron">
	...
	<div class="post-inner-content container">
        ...
        <?php the_title(); ?>
			...
			<div class="entry-meta">
				<?php contractcloud_posted_on(); ?>

				<?php
					/* translators: used between list items, there is a space after the comma */
					$categories_list = get_the_category_list( esc_html__( ', ', 'contractcloud' ) );
					if ( $categories_list && contractcloud_categorized_blog() ) :
				?>
				<span class="cat-links"><i class="fa fa-folder-open-o"></i>
					<?php printf( esc_html__( ' %1$s', 'contractcloud' ), $categories_list ); ?>
				</span>
	...
	<?php if (get_the_author_meta('description')) :  ?>
		<div class="post-inner-content secondary-content-box container">
      <!-- author bio -->
